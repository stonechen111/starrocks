...
public class LakeTableAlterDataCacheEnableTest {
    ...
    public void before() throws Exception {
        ...
        new MockUp<StarOSAgent>() {
            @Mock
            public void alterShards(LakeTable table, boolean enableCache) {

            }

            @Mock
            public void alterShards(Partition partition, boolean enableCache) {
    ...
    @Test
    public void testModifyDataCacheEnableToFalse() throws Exception {
        ...
        Assert.assertEquals(false, table.getTableProperty().getStorageInfo().getDataCacheInfo().isEnabled());

    }

    @Test
    public void testModifyDataCacheEnableToTrue() throws Exception {
        Map<String, String> properties = new HashMap<>();
        ...
        Assert.assertEquals(true, table.getTableProperty().getStorageInfo().getDataCacheInfo().isEnabled());
